...
<head>
    ...
    <link
        rel="stylesheet"
        href="https://cdn.jsdelivr.net/npm/sgds-govtech@1.3.2/css/sgds.css"
    />
    ...
</head>
```
...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sgds-govtech@1.3.2/js/sgds.js"></script>
    ...
</body>
```
...
<!-- JS in <body> -->
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
<script src="https://raw.githubusercontent.com/GovTechSG/sgds/dev_preview/js/sgds.js"></script>
```
