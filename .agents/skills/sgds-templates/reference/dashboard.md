    ...
    <sgds-sidebar-section title="Analytics" name="analytics">
      ...
      <sgds-sidebar-group name="submissions" title="Submissions">
        ...
        <sgds-sidebar-item name="all-submissions" title="All submissions">
          <sgds-icon name="files" slot="icon" size="md"></sgds-icon>
        </sgds-sidebar-item>
        <sgds-sidebar-item name="pending" title="Pending review">
          <sgds-icon name="pending-circle" slot="icon" size="md"></sgds-icon>
        </sgds-sidebar-item>
        <sgds-sidebar-item name="approved" title="Approved">
          <sgds-icon name="check-circle-fill" slot="icon" size="md"></sgds-icon>
        </sgds-sidebar-item>
      </sgds-sidebar-group>
      <sgds-sidebar-item name="reports" title="Reports">
        <sgds-icon name="speedometer" slot="icon" size="md"></sgds-icon>
        <a href="/reports"></a>
      </sgds-sidebar-item>
