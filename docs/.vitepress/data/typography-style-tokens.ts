...
export const typographyStyleSections: readonly TokenSection[] = [
  ...
  },
  {
    ...
    rows: [
      {
        tokenNames: ["sgds-list-lg-regular"],
        example: "List large regular",
        description: "This is commonly used in the order list or unordered list",
        exampleClass: "tokenExampleListLg",
        aliases: ["--sgds-font-size-list-lg", "--sgds-font-weight-regular", "--sgds-line-height-md", "--sgds-letter-spacing-normal", "--sgds-list-spacing-lg"],
      },
      {
        tokenNames: ["sgds-list-md-regular"],
        example: "List medium regular",
        description: "This is commonly used in the order list or unordered list",
        exampleClass: "tokenExampleListMd",
        aliases: ["--sgds-font-size-list-md", "--sgds-font-weight-regular", "--sgds-line-height-xs", "--sgds-letter-spacing-normal", "--sgds-list-spacing-md"],
        note: "Default",
      },
      {
        tokenNames: ["sgds-list-sm-regular"],
        example: "List small regular",
        description: "This is commonly used in the order list or unordered list",
        exampleClass: "tokenExampleListSm",
        aliases: ["--sgds-font-size-list-sm", "--sgds-font-weight-regular", "--sgds-line-height-2-xs", "--sgds-letter-spacing-normal", "--sgds-list-spacing-sm"],
      },
    ],
  },
];
