...
export const searchIndex: SearchItem[] = [
  ...
  { title: "Figma workflows", category: "AI", url: "/ai/figma-and-code-workflows", keywords: ["ai", "workflow", "figma", "mcp", "code to figma", "figma to code", "designer developer handoff"] },
  { title: "Development workflows", category: "AI", url: "/ai/development-workflows", keywords: ["ai", "workflow", "new project", "existing project", "developers", "code", "prompt to code", "sgds skills"] },
  ...
  { title: "Agent skills", category: "AI", url: "/ai/skills", keywords: ["skills", "agent skills", "install", "setup", "configure"] },
  ...
  { title: "MCP server", category: "AI", url: "/ai/figma-and-code-workflows", keywords: ["mcp", "server", "figma"] },
  { title: "MCP server setup", category: "AI", url: "/ai/mcp-server-setup", keywords: ["mcp", "server", "setup"] },
  { title: "Figma to code", category: "AI", url: "/ai/figma-and-code-workflows", keywords: ["figma", "design", "code"] },
];
