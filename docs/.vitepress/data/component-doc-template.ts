  ...
  measurementTokenGroups: [
    {
      ...
      tokens: [
        { element: "Header padding", property: "padding-x", designToken: "sgds/padding/lg", rawValue: "20px" },
        { element: "",               property: "padding-y", designToken: "sgds/padding/lg", rawValue: "20px" },
        { element: "Content padding", property: "padding-top",    designToken: "sgds/padding/xs", rawValue: "4px" },
        { element: "",                property: "padding-bottom", designToken: "sgds/padding/lg", rawValue: "20px" },
      ],
    },
    {
      title: "sgds/TODO-component/compact",
      tokens: [
        { element: "Header padding", property: "padding-x", designToken: "sgds/padding/md", rawValue: "16px" },
        { element: "",               property: "padding-y", designToken: "sgds/padding/md", rawValue: "16px" },
        { element: "Content padding", property: "padding-top",    designToken: "sgds/padding/xs", rawValue: "4px" },
        { element: "",                property: "padding-bottom", designToken: "sgds/padding/md", rawValue: "16px" },
      ],
    },
    {
      title: "sgds/TODO-component/spacious",
      tokens: [
        { element: "Header padding", property: "padding-x", designToken: "sgds/padding/xl", rawValue: "24px" },
        { element: "",               property: "padding-y", designToken: "sgds/padding/xl", rawValue: "24px" },
        { element: "Content padding", property: "padding-top",    designToken: "sgds/padding/xs", rawValue: "4px" },
        { element: "",                property: "padding-bottom", designToken: "sgds/padding/xl", rawValue: "24px" },
      ],
    },
  ],
