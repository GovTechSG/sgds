...
<template>
  <div class="sgds:bg-surface-raised sgds:border sgds:border-muted sgds:rounded-xl sgds:flex sgds:flex-col sgds:gap-[var(--sgds-gap-2-xs)] sgds:min-w-0 sgds:max-w-full sgds:py-[var(--sgds-padding-md)] sgds:px-[var(--sgds-component-padding-xs)] sgds:w-full">
