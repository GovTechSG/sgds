...
const fontSizeGroups = [
  ...
  },
  {
    ...
    sizes: [
      { name: "Medium", utilityClass: "sgds:text-subtitle-md", token: "--sgds-font-size-subtitle-md", mobile: "18", tablet: "18", desktop: "20" },
  ...
  },
  {
    ...
    sizes: [
      { name: "Large",  utilityClass: "sgds:text-body-lg", token: "--sgds-font-size-body-lg", mobile: "18", tablet: "18", desktop: "20" },
  ...
  },
  {
    ...
    sizes: [
      { name: "Large",  utilityClass: "sgds:text-label-lg", token: "--sgds-font-size-label-lg", mobile: "18", tablet: "18", desktop: "20" },
  ...
  },
  {
    ...
    sizes: [
      { name: "Large",  utilityClass: "sgds:text-link-lg", token: "--sgds-font-size-link-lg", mobile: "18", tablet: "18", desktop: "18" },
