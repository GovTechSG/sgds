...
<template>
  <div v-if="doc" class="sgds:flex sgds:flex-col" :data-component-page="currentPageKey">
    <sgds-tab-group ref="tabGroupRef" class="sgds:block sgds:w-full" variant="underlined">
      <sgds-tab slot="nav" panel="design" active :ariaLabel.prop="'Design'" @click="handleTabClick('design')">Design</sgds-tab>
      <sgds-tab slot="nav" panel="usage" :ariaLabel.prop="'Usage'" @click="handleTabClick('usage')">Usage</sgds-tab>
      <sgds-tab slot="nav" panel="accessibility" :ariaLabel.prop="'Accessibility'" @click="handleTabClick('accessibility')">Accessibility</sgds-tab>
      <sgds-tab slot="nav" panel="updates" :ariaLabel.prop="'Updates'" @click="handleTabClick('updates')">Updates</sgds-tab>
