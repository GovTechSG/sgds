  ...
  <div :class="$style.page">
    <section :class="$style.section">
      <div :class="$style.sectionHeader">
        <h3 class="sgds:text-heading-md sgds:font-semibold sgds:leading-md sgds:tracking-tight">The role of AI in design systems</h3>
      </div>
    ...
    <section :class="$style.section">
      <div :class="$style.sectionHeader">
        <h3 class="sgds:text-heading-sm sgds:font-semibold sgds:leading-sm sgds:tracking-tight">Why system quality matters when teams build with AI</h3>
        <a href="#why-system-quality-matters-when-teams-build-with-ai" :class="$style.anchorLink" aria-label="Link to section">
    ...
    <section :class="$style.section">
      <h3 class="sgds:text-heading-sm sgds:font-semibold sgds:leading-sm sgds:tracking-tight">What this means for teams building with SGDS</h3>
      <div :class="$style.sectionBody">
        <p class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal">
        ...
        <ul :class="$style.list">
          ...
          <li><strong>Less time fixing AI-generated work</strong> — when the rules are already defined and accessible, AI is less likely to guess wrong</li>
          <li><strong>Faster workflows from idea to implementation</strong> — the foundation is already in place, so teams spend time building, not deciding how to build or fixing UI that drifted from the standard</li>
          <li><strong>Confidence that what you build meets expected standards</strong> — accessibility requirements and government design standards are built into the system, not added later</li>
        </ul>
      </div>
    </section>
    ...
    <section :class="$style.section">
      <div :class="$style.sectionHeader">
        <h3 class="sgds:text-heading-sm sgds:font-semibold sgds:leading-sm sgds:tracking-tight">How SGDS is evolving for AI</h3>
        <a href="#how-sgds-is-evolving-for-ai" :class="$style.anchorLink" aria-label="Link to section">
          <sgds-icon name="link-45deg" size="sm"></sgds-icon>
        </a>
      </div>
      <div :class="$style.sectionBody">
