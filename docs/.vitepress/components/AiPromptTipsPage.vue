      ...
      <sgds-tab-group variant="underlined">
        ...
        <sgds-tab-panel name="new-app">
          <div :class="$style.panel">
            ...
            <div :class="$style.listBlock">
              ...
              <ul :class="$style.list" class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal">
              ...
              <p class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal after-list-note">
                <br />
        ...
        <sgds-tab-panel name="migrating-app">
          <div :class="$style.panel">
            ...
            <div :class="$style.followupBlock">
              <p class="sgds:text-body-md sgds:font-semibold sgds:leading-xs sgds:tracking-normal">Putting it all together</p>
              <p class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal">
