...
headerAlert:
  title: Do not use this page
  description: The content on this page is not discussed and done yet. Treat it as reference only for now.
  variant: danger
  outlined: true
...
<script setup>
import CodeToken from "../.vitepress/components/CodeToken.vue";
</script>
...
<p class="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal body-copy">
  <a href="/ai/agent-skills">→ Learn about agent skills</a>
</p>
